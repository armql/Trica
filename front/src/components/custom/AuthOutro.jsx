...
function AuthOutro({ essentials, type, effect, auto }) {
  return (
    <div className="py-4 flex-shrink-0 px-0 h-full">
      <div
        className={`flex gap-2 flex-col items-center justify-end w-full ${
          type === "signup" ? "h-full" : "h-full"
        }`}
      >
        ...
        <div className="w-[60vw]">
          <button
            ...
            className={`
      h-full border py-2.5 text-2xl flex items-center font-bold w-full rounded-full px-12 transition-all duration-300 shadow-md
      ${
        effect != false
          ? "bg-[#0008C7] group text-white border-[#0008C7] justify-center gap-4 hover:bg-blue-800 hover:border-blue-800 active:bg-[#0008C7] active:border-[#0008C7]"
...
export default React.memo(AuthOutro);
